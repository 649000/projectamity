...
${remoteFunction(action:'listRequest', onSuccess:'listRequests(e)', params:'\'resident=\'+resident')}
  ...
  <body class="thrColFixHdr"  onload="loadHide()">
    ...
    <div class="wrapper">
      ...
      <div id="container">
        <a href="../ProjectAmity" >
        <img src="${resource(dir:'images/amity',file:'logo3.PNG')}" id="logo"/></a>
        ...
        <img src="${resource(dir:'images/amity',file:'report.png')}" id="report"/></a>
        <a href="${createLink(controller: 'carpoolListing', action:'index')}" >
        <img src="${resource(dir:'images/amity',file:'carpool.png')}" id="carpool"/></a>
        <a href="${createLink(controller: 'barter', action:'index')}" >
        <img src="${resource(dir:'images/amity',file:'barter.png')}" id="barter"/></a>
        <a href="${createLink(controller: 'barter', action:'index')}" >
        <img src="${resource(dir:'images/amity',file:'bbarter.png')}" id="pageTitle"/></a>
        <div id="header">
          <h1>test</h1>
          <!-- end #header --></div>
        <div id="banner">&nbsp;</div>
