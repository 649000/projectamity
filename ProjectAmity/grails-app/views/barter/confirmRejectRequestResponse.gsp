...
changeDivMessage = function()
{
  ...
  <g:hiddenField name="message" value="${params.messageReject}" id="message" />
  ...
  <g:hiddenField name="requestid" value="${params.requestid}" id="requestid" />
      ...
      <g:textArea rows="6" cols="72" name="message">${params.messageReject}</g:textArea>
      <br/><g:actionSubmit value="Confirm reject request" onclick="sendRequest()"/>
